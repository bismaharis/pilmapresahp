    ...
    <div class="py-6 md:py-12">
        <div class="max-w-7xl mx-auto px-3 md:px-6 lg:px-8">
            ...
            @php
                ...
                $capaianBorderClass = $errors->has('capaian') ? 'border-red-500' : 'border-gray-300';
                $categoryBorderClass = $errors->has('category') ? 'border-red-500' : 'border-gray-300';
                $levelBorderClass = $errors->has('level') ? 'border-red-500' : 'border-gray-300';
                $yearBorderClass = $errors->has('year') ? 'border-red-500' : 'border-gray-300';
                $typeBorderClass = $errors->has('type') ? 'border-red-500' : 'border-gray-300';
                $jumlahPesertaBorderClass = $errors->has('jumlah_peserta') ? 'border-red-500' : 'border-gray-300';
                $jumlahPenghargaanBorderClass = $errors->has('jumlah_penghargaan') ? 'border-red-500' : 'border-gray-300';
                $organizerBorderClass = $errors->has('organizer') ? 'border-red-500' : 'border-gray-300';
                $fileProofBorderClass = $errors->has('file_proof') ? 'border-red-500' : 'border-gray-300';
            @endphp
            @if ($errors->any())
                    ...
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-4 md:p-6">
                        ...
                        <form action="{{ route('student.achievements.store') }}" method="POST" enctype="multipart/form-data" 
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="name" value="{{ old('name') }}" class="mt-1 block w-full rounded-md shadow-sm {{ $nameBorderClass }} placeholder:text-xs md:placeholder:text-sm text-sm" placeholder="Contoh: KTI Nasional" required>
                                @error('name') <p class="text-red-500 text-xs mt-1 font-bold">{{ $message }}</p> @enderror
                            </div>

                            <div class="mb-4">
                                <label class="block text-xs md:text-sm font-medium text-gray-700">Capaian</label>
                                <input type="text" name="capaian" value="{{ old('capaian') }}" class="mt-1 block w-full rounded-md shadow-sm {{ $capaianBorderClass }} placeholder:text-xs md:placeholder:text-sm text-sm" placeholder="Contoh: Juara 1" required>
                            ...
                            <div class="mb-4">
                                ...
                                <select name="category" class="mt-1 block w-full rounded-md shadow-sm {{ $categoryBorderClass }} text-xs md:text-sm" required>
                            ...
                            <div class="grid grid-cols-2 gap-3 md:gap-4 mb-4">
                                <div>
                                    ...
                                    <select name="level" class="mt-1 block w-full rounded-md shadow-sm {{ $levelBorderClass }} text-xs md:text-sm" required>
                                ...
                                <div>
                                    ...
                                    <select name="year" class="mt-1 block w-full rounded-md shadow-sm {{ $yearBorderClass }} text-xs md:text-sm" required>
                            ...
                            <div class="grid grid-cols-2 gap-3 md:gap-4 mb-4">
                                <div>
                                    ...
                                    <select name="type" class="mt-1 block w-full rounded-md shadow-sm {{ $typeBorderClass }} text-xs md:text-sm" required>
                                ...
                                <div>
                                    ...
                                    <input type="number" name="jumlah_peserta" value="{{ old('jumlah_peserta') }}" class="mt-1 block w-full rounded-md shadow-sm {{ $jumlahPesertaBorderClass }} text-xs md:text-sm" min="1" required>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="jumlah_penghargaan" value="{{ old('jumlah_penghargaan') }}" class="mt-1 block w-full rounded-md shadow-sm {{ $jumlahPenghargaanBorderClass }} text-xs md:text-sm" placeholder="Contoh: 3 Medali per Kategori" required>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="organizer" value="{{ old('organizer') }}" class="mt-1 block w-full rounded-md shadow-sm {{ $organizerBorderClass }} text-xs md:text-sm" required>
